      ...
      <div className="page-recurring">
        <div className="total-summary">
          <div className="page-recurring-totalbills">
            <div className="page-recurring-totalbills-icon">
              {' '}
        ...
        <div className="page-recurring-billslogs">
          <div className="page-recurring-controls">
            <div>
              <input type="text" placeholder="Search transactions" className="recurring-search" />
            </div>

            <div className="recurring-controls-dropdown text-preset-4">
              Sort by
              <div>
